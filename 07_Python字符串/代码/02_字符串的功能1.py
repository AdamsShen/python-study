...
# print(int('3.14'))  # 不能将小数字符串直接转换成整数，报错
...
print(s.find('very')) #8
print(s.find('lunhan')) #-1

print(s.rfind('very')) # 18
print(s.rfind('lunhan')) #-1
...
print(s1.split('ikun'))
print(s1.split(' ', 2)) # ['ikun', 'is', 'very very very handsome']
...
s1 = "ikun     is very very very handsome"
s2 = s1.replace('very', 'test') # 'ikun     is test test test handsome'
print(s2)
